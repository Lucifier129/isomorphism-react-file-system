...
/***/ function(module, exports, __webpack_require__) {
	...
	var _view1 = __webpack_require__(199);

	var _view12 = _interopRequireDefault(_view1);

	var _storeTree = __webpack_require__(216);

	var _storeTree2 = _interopRequireDefault(_storeTree);

	var _libDispatcher = __webpack_require__(220);
	...
	var App = (function () {
		...
		_createClass(App, [{
			...
			value: function render() {
				_react2['default'].render(_react2['default'].createElement(_view12['default'], { tree: this.store }), document.getElementById('container'));
			}
		}]);
	...
	new App(_view12['default'], _storeTree2['default']).init();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = module.exports = __webpack_require__(162)({
	  g: global,
	  core: core,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(161).core.Object.assign;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(167);
	$def($def.S, 'Object', {assign: __webpack_require__(168)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(161).core.Promise;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cof = __webpack_require__(173)
	  , tmp = {};
	tmp[__webpack_require__(174)('toStringTag')] = 'z';
	if(__webpack_require__(161).FW && cof(tmp) != 'z'){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global = __webpack_require__(161).g
	  , store  = __webpack_require__(175)('wks');
...
/***/ function(module, exports, __webpack_require__) {
	...
	uid.safe = __webpack_require__(161).g.Symbol || uid;
	module.exports = uid;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(161).hide;

/***/ },
/* 178 */
/***/ function(module, exports, __webpack_require__) {

	var set   = __webpack_require__(161).set
	  , $at   = __webpack_require__(179)(true)
	  , ITER  = __webpack_require__(176).safe('iter')
	  , $iter = __webpack_require__(180)
	  , step  = $iter.step;
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $                 = __webpack_require__(161)
	  , cof               = __webpack_require__(173)
	  , classof           = cof.classof
	  , assert            = __webpack_require__(181)
	  , assertObject      = assert.obj
	  , SYMBOL_ITERATOR   = __webpack_require__(174)('iterator')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $           = __webpack_require__(161)
	  , Iterators   = __webpack_require__(180).Iterators
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(161)
	  , setUnscope = __webpack_require__(185)
	  , ITER       = __webpack_require__(176).safe('iter')
	  , $iter      = __webpack_require__(180)
	  , step       = $iter.step
	  , Iterators  = $iter.Iterators;
	...
	__webpack_require__(182)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(161)
	  ...
	  , cof      = __webpack_require__(173)
	  , $def     = __webpack_require__(167)
	  , assert   = __webpack_require__(181)
	  , forOf    = __webpack_require__(189)
	  , setProto = __webpack_require__(191).set
	  , same     = __webpack_require__(187)
	  , species  = __webpack_require__(192)
	  , SPECIES  = __webpack_require__(174)('species')
	  , RECORD   = __webpack_require__(176).safe('record')
	  , PROMISE  = 'Promise'
	  , global   = $.g
	  , process  = global.process
	  , asap     = process && process.nextTick || __webpack_require__(193).set
	  , P        = global[PROMISE]
	  , isFunction     = $.isFunction
	  , isObject       = $.isObject
	...
	$def($def.S + $def.F * !(useNative && __webpack_require__(197)(function(iter){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctx  = __webpack_require__(188)
	  , get  = __webpack_require__(180).get
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYMBOL_ITERATOR = __webpack_require__(174)('iterator')
	  , SAFE_CLOSING    = false;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentBreadcrumb = __webpack_require__(215);

	var _componentBreadcrumb2 = _interopRequireDefault(_componentBreadcrumb);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cloud = __webpack_require__(208);
	...
	var _Download = __webpack_require__(210);

	var _Download2 = _interopRequireDefault(_Download);

	var _Edit = __webpack_require__(211);
	...
	var _Folder = __webpack_require__(213);
	...
	exports['default'] = { Icon: _Icon2['default'], Add: _Add2['default'], Cloud: _Cloud2['default'], Delete: _Delete2['default'], Download: _Download2['default'], Edit: _Edit2['default'], File: _File2['default'], Folder: _Folder2['default'], Settings: _Settings2['default'] };
	module.exports = exports['default'];
		...
		_createClass(Icon, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement('span', { className: ['icon', type].join(' ') })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Add = (function (_React$Component) {
		...
		_createClass(Add, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(_Icon2['default'], _extends({}, this.props, { type: 'icon-add', name: 'Add' }));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cloud = (function (_React$Component) {
		...
		_createClass(Cloud, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(_Icon2['default'], _extends({}, this.props, { type: 'icon-cloud', name: 'Cloud' }));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Delete = (function (_React$Component) {
		...
		_createClass(Delete, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(_Icon2['default'], _extends({}, this.props, { type: 'icon-delete', name: 'Delete' }));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Download = (function (_React$Component) {
		...
		_createClass(Download, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(_Icon2['default'], _extends({}, this.props, { type: 'icon-file-download', name: 'Download' }));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Edit = (function (_React$Component) {
		...
		_createClass(Edit, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(_Icon2['default'], _extends({}, this.props, { type: 'icon-mode-edit', name: 'Edit' }));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var File = (function (_React$Component) {
		...
		_createClass(File, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(_Icon2['default'], _extends({}, this.props, { type: 'icon-insert-drive-file', name: 'File' }));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Folder = (function (_React$Component) {
		...
		_createClass(Folder, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(_Icon2['default'], _extends({}, this.props, { type: 'icon-folder', name: 'Folder' }));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Settings = (function (_React$Component) {
		...
		_createClass(Settings, [{
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(_Icon2['default'], _extends({}, this.props, { type: 'icon-settings', name: 'Settings' }));
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIterator = __webpack_require__(217)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(161).core.getIterator;

/***/ },
/* 219 */
/***/ function(module, exports, __webpack_require__) {

	var core  = __webpack_require__(161).core
	  , $iter = __webpack_require__(180);
